...
Una frontera adicional que este corpus no resuelve es la estabilidad
cross-torneo de la propiedad. Si Mbappé aparece como
\textit{pressure-clutch} en el Mundial 2022, ¿lo sería también en la
Eurocopa 2024, en los partidos de eliminatoria de \textit{Champions}
o en el siguiente Mundial? Esa pregunta importa especialmente al uso
aplicado del marco en mercado de fichajes y exige replicar el
\textit{pipeline} sobre corpus adicionales con la misma estructura,
algo factible con futuras liberaciones abiertas de \textit{eventing}
y tracking pero fuera del alcance del presente trabajo.
