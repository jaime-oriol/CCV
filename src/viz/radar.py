...
Variantes:
  - 8 ejes  (PCJ_METRICS / PCJ_TITLES):    4 canales x 2 contextos (tras GA, tras GF)
  - 12 ejes (PCJ_METRICS_12 / _TITLES_12): 4 canales x 3 contextos (tras GA, tras GF, bajo presión)
